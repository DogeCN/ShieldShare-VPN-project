 ...
 * Handles SOCKS5 protocol for tunneling various types of traffic
...
class Socks5ProxyHandler(
    ...
    private suspend fun handleSocks5Request() = withContext(Dispatchers.IO) {
    ...
    private suspend fun establishTargetConnection(
        ...
        try {
            ...
            // Send success reply
            sendConnectionReply(output, REPLY_SUCCESS, targetSocket.localAddress, targetSocket.localPort)
    ...
    private fun sendConnectionReply(
        ...
        try {
            ...
            if (bindAddress != null && bindAddress is Inet4Address) {
                ...
                val fullReply = reply + bindAddress.address + byteArrayOf(
    ...
    private suspend fun startTunneling(targetSocket: Socket) = withContext(Dispatchers.IO) {
